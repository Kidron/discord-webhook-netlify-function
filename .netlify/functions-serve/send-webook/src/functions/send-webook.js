          ...
          if (fetch4.isRedirect(res.statusCode)) {
            ...
            switch (request.redirect) {
              ...
              case "follow":
                ...
                resolve(fetch4(new Request2(locationURL, requestOpts)));
                finalize();
                return;
            }
          }
...
var require_SupabaseClient = __commonJS({
  "node_modules/@supabase/supabase-js/dist/main/SupabaseClient.js"(exports2) {
    ...
    var SupabaseClient = class {
      ...
      _initSupabaseAuthClient({ autoRefreshToken, persistSession, detectSessionInUrl, localStorage, headers, fetch: fetch4, cookieOptions, multiTab }) {
        const authHeaders = {
...
var require_database = __commonJS({
  "utils/database.js"(exports2, module2) {
    var dotenv2 = require_main();
    dotenv2.config();
    var { createClient } = require_main7();
    var supabaseUrl = process.env.SUPABASE_URL;
    var supabaseKey = process.env.SUPABASE_KEY;
    var supabase2 = createClient(supabaseUrl, supabaseKey);
    module2.exports = { supabase: supabase2 };
  }
});
...
// functions/send-webook.mjs
var { supabase } = require_database();
var fetch3 = (init_src(), src_exports);
...
Credits to https://multidollar.company/, if they go down the count will be off`
  ...
  try {
    discordData.forEach((url) => {
      fetch3(url.discord_url, options);
...
//# sourceMappingURL=send-webook.js.map
